          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                {errors.linkedin && (
                  <p className="text-red-600 text-xs ml-1">{errors.linkedin}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.twitter && (
                  <p className="text-red-600 text-xs ml-1">{errors.twitter}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.facebook && (
                  <p className="text-red-600 text-xs ml-1">{errors.facebook}</p>
                )}
              </div>
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                {errors.tiktok && (
                  <p className="text-red-600 text-xs ml-1">{errors.tiktok}</p>
                )}
              </div>
            </div>
